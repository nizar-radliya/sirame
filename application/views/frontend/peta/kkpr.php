...
<script>
	...
	var kkpr_peta = new L.GeoJSON.AJAX("<?php echo base_url(); ?>assets/map/layer/kkpr_peta.php", {
		style: function (feature) {
			return {
				color: '#000000',
				dashArray: '1',
		...
		onEachFeature: function (feature, layer) {
			...
			var customPopup =
				...
				"<tr><td>Tangggal Terbit</td>" +
				"<td>" + feature.properties.tglterbit + "</td></tr>" +
				"<tr><td>Pelaku Usaha</td>" +
				"<td>" + feature.properties.namapelaku + "</td></tr>" +
				"<tr><td>Judul KBLI</td>" +
				"<td>" + feature.properties.judulkbli + "</td></tr>" +
				"<tr><td>Alamat Usaha</td>" +
				"<td>" + feature.properties.alamatusaha + "</td></tr>" +
				"<tr><td>Luas Dimohonkan</td>" +
				"<td>" + feature.properties.luasdimohon + "</td></tr>" +
				"<tr><td>Luas Disetujui</td>" +
				"<td>" + feature.properties.luasdisetujui + "</td></tr>" +
				"</table>";
			// specify popup options
			var customOptions =
				{
	...
	}).addTo(peta); // layer peta kkpr_peta ini ditmbahkan ke dalam variabel 'peta'
	...
	var kkpr_pelaporan = new L.GeoJSON.AJAX("<?php echo base_url(); ?>assets/map/layer/kkpr_pelaporan.php", {
		style: function (feature) {
			...
			var fillcolor;
			if (statuslaporan == 'MENUNGGU VERIFIKASI' || statuslaporan == 'PELAPORAN DITERIMA') {
	...
	var overlaysTree = [
		...
		{label: " <span style='font-size:12px;'>PKKPR</span><br><div class='boxlegend' style='background-color: #000000'></div>", layer: kkpr_peta.addTo(map)},
		{label: ' <div id="onlysel" style="margin-top: 0"><span style="font-weight: bold">PELAPORAN PKKPR</span></div>'},
		{label: " Sketsa Lokasi Pelaporan<br><div><div class='boxlegend' style='background-color: #D10000'></div><span style='font-size:12px;'>BELUM VERIFIKASI</span></div><br><div><div class='boxlegend' style='background-color: #00A300'></div><span style='font-size:12px;'>LAPORAN DITERIMA</span></div>", layer: kkpr_pelaporan.addTo(map)},
		...
		if (props != undefined) {
			if (props.idpr != undefined) {
				...
				this._div.innerHTML = '<h4 style="font-style: italic; text-align: center; margin-bottom: 10px">PKKPR</h4>' + (props ?
					'<table class="table table-bordered" style="text-align: justify; margin: 0;">' +
					'<tr><th style="padding: 2px 0">Nomor PKKPR</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.nomor + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Tangggal Terbit</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.tglterbit + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Pelaku Usaha</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.namapelaku + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Judul KBLI</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.judulkbli + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Alamat Usaha</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.alamatusaha + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Luas Disetujui</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.luasdisetujui + '</td></tr>' +
					'</table>'
					: '');
			} else if (props.idpelaporan != undefined) {
				this._div.innerHTML = '<h4 style="font-style: italic; text-align: center; margin-bottom: 10px">PKKPR</h4>' + (props ?
					'<table class="table table-bordered" style="text-align: justify; margin: 0;">' +
					'<tr><th style="padding: 2px 0">Nomor PKKPR</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.nomor + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Jenis Dokumen</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.jenisdok + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Nomor Dokumen</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.nomordok + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Tanggal Dokumen</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.tgldok + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Luas Tanah</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.luasrealisasi + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Pejabat Pengesahan</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.pejabat + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Status Laporan</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.statuslaporan + '</td></tr>' +
					'<tr><th style="padding: 2px 0">Tanggal Laporan</th><td style="padding: 2px">:</td><td style="padding: 2px">' + props.tglpelaporan + '</td></tr>' +
					'</table>'
					: '');
			} else {
