            ...
            <div class="box box-success">
				<div class="box-header with-border">
					<span style="font-size: 12px; font-style: italic">*Data pelaporan PKKPR tidak dapat diubah atau dihapus apabila sudah berstatus "KELENGKAPAN DITERIMA".</span>
						<a href="<?php echo base_url(); ?>kkpr-adm/form-add">
						...
						<table id="example1" class="table table-bordered table-striped" style="width: 2000px">
							...
							<?php $n=1; foreach ($kkpr as $field) { ?>
								<tr>
									<td><?php echo $n++; ?></td>
									<td style="width: auto">
										<a href="<?php echo base_url(); ?>kkpr-adm/detil/<?= $field->nomor; ?>">
										...
										<?php if ($field->statuskkpr != 'PKKPR VALID') { ?>
											<a href="<?php echo base_url(); ?>kkpr-adm/form-edit/<?= $field->nomor; ?>">
										...
										<?php } ?>
											<a href="<?php echo base_url(); ?>kelengkapan-adm/index/<?= $field->nomor; ?>">
												<button type="button" class="btn bg-purple btn-flat margin" title="Persyaratan" style="margin: 0; min-width: 40px">
													<span class="fa fa-check-square-o"></span>
												</button>
											</a>
										<?php if ($field->statuskkpr == 'PKKPR VALID') { ?>
											<a href="<?php echo base_url(); ?>kelengkapan-adm/tanda-terima/<?= $field->nomor; ?>" target="_blank">
...
<script>
	$(function(){
		...
		$(document).on('click','.edit-record',function(e){
			e.preventDefault();
			$("#myModal").modal('show');
			$.get('<?php echo base_url(); ?>kkpr-adm/form_del',
