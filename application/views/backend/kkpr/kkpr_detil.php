...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><i class="fa fa-file-text-o"></i> Detil PKKPR</li>
		</ol>
	</section>
	<!-- Main content -->
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="box box-success" style="margin-bottom: 0">
					<div class="box-header with-border">
						...
						<select class="form-control select2" name="" id="iddi" style="width: auto" onchange="javascript:location.href = this.value;">
							...
							<?php foreach ($noreg as $field) { ?>
								<?php if ($field->nomor == $kkpr[0]->nomor) { ?>
									<option value="<?php echo base_url(); ?>kkpr/detil/<?= $field->nomor; ?>" selected><?= $field->nomor; ?></option>
								<?php } else { ?>
									<option value="<?php echo base_url(); ?>kkpr/detil/<?= $field->nomor; ?>"><?= $field->nomor; ?></option>
								<?php } } ?>
						</select>

						<?php if ($kkpr[0]->statuskkpr == 'PERSYARATAN BELUM LENGKAP' || $kkpr[0]->statuskkpr == 'MENUNGGU VERIFIKASI PERSYARATAN') { ?>
							<a href="#" class="edit-record" data-id="<?= $kkpr[0]->nomor; ?>">
								<button type="button" class="btn bg-red btn-flat margin pull-right"
						...
						<?php } ?>
						<?php if ($kkpr[0]->statuskkpr == 'PERSYARATAN BELUM LENGKAP' || $kkpr[0]->statuskkpr == 'MENUNGGU VERIFIKASI PERSYARATAN') { ?>
							<a href="<?php echo base_url(); ?>kkpr/form-edit/<?= $kkpr[0]->nomor; ?>">
								<button type="button" class="btn bg-blue btn-flat margin pull-right"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Yakin akan menghapus data ini? Data kkpr tidak dapat dihapus apabila sudah berhasil verifikasi persyaratan.</p>
			</div>
