		...
		<div class="box box-success">
			<div class="box-header with-border">
				<select class="form-control select2" name="" id="iddi" style="width: auto" onchange="javascript:location.href = this.value;">
					...
					<option value="<?php echo base_url(); ?>pengaduan-adm/grafik">Semua Tahun</option>
					<?php foreach ($tahun as $field) { ?>
					<?php if ($field->year == $year) { ?>
					<option value="<?php echo base_url(); ?>pengaduan-adm/grafik-pertahun/<?= $field->year; ?>" selected><?= $field->year; ?></option>
					<?php } else { ?>
				...
				<div class="col-sm-6" style="padding: 0;">
					<table class="table table-bordered" style="margin-bottom: 0">
						...
						<tr>
							...
							<td><span class="badge bg-aqua"><?= number_format($pm5,2) ?>%</span></td>
						</tr>
						<tr>
							<td>6.</td>
							<td>PENGKAJIAN TEKNIS</td>
							<td><span class="badge bg-blue"><?= $pengaduan6 ?></span></td>
							<td><span class="badge bg-blue"><?= number_format($pm6,2) ?>%</span></td>
						</tr>
						<tr>
							<td>7.</td>
							<td>DRAFT SURAT</td>
							<td><span class="badge bg-purple"><?= $pengaduan7 ?></span></td>
							<td><span class="badge bg-purple"><?= number_format($pm7,2) ?>%</span></td>
						</tr>
						<tr>
							<td>8.</td>
							<td>PENOMORAN SURAT</td>
							<td><span class="badge bg-green"><?= $pengaduan8 ?></span></td>
							<td><span class="badge bg-green"><?= number_format($pm8,2) ?>%</span></td>
						</tr>
					</table>
				</div>
