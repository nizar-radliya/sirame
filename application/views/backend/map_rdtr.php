					...
					<a data-toggle="collapse" href="#collapseTwo" title="Data Atribut Peta">
						...
						<script>
							...
							var rdtr_rencana_polaruang = new L.GeoJSON.AJAX("<?php echo base_url(); ?>assets/map/layer/rdtr_rencana_polaruang.php", {
								...
								onEachFeature: function (feature, layer) {
									...
									var customPopup =
										...
										"<tr><td>Kode Zona</td>" +
										"<td>" + feature.properties.d_kodzon + "</td></tr>" +
										"<tr><td>Nama Zona</td>" +
										"<td>" + feature.properties.d_namzon + "</td></tr>" +
										"<tr><td>Kode Sub Zona</td>" +
										"<td>" + feature.properties.d_kodszn + "</td></tr>" +
										"<tr><td>Nama Sub Zona</td>" +
							...
							var overlays = {
								...
								"<span style='color: #3C8DBC; font-size: 14px'>RDTR MARTAPURA</span>": {
