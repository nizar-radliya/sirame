...
<body class="hold-transition login-page" style="background-color: #000000; background-size: cover;">
<div class="login-box" style="margin-bottom: 0; margin-top: 30px">
    <div class="login-logo" style="margin-bottom: 5px; line-height: 70%; width: 100%">
        <img src="<?php echo base_url(); ?>/assets/lte/img/icon.png" width="100">
        <br>
        <a href="<?php echo base_url(); ?>" style="color: #FFFFFF; font-size: 18px;"><b>SIMTARU</b><br>KABUPATEN OKU TIMUR</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body" style="border: 1px solid #9e9e9e">
        ...
        <?php if($this->session->flashdata('success')) { ?>
            <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check-circle-o"></i>Berhasil!</h4>
