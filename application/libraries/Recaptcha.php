...
class ReCaptcha {
    ...
    public function render() {
        $return = '<div class="g-recaptcha" data-sitekey="' . $this->_sitekey . '" style="margin: 0 auto; display: table; transform:scale(0.85);-webkit-transform:scale(0.85);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
