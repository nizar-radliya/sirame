								...
								<table class="table table-bordered" style="margin-bottom: 0">
									...
									<tr>
										...
										<td width="50%">
											...
											<span class="text-green">*Ukuran maksimal file 3 MB (pdf/doc/docx)</span>
										</td>
									</tr>
									<tr>
										<td>
											<label>Nomor Dokumen</label>
											<input type="text" class="form-control" name="nomordok" minlength="8" autocomplete="off" required>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											...
											<input type="text" class="form-control" name="pejabat" minlength="5" autocomplete="off" required>
										</td>
									</tr>
									</tr>
									<tr>
