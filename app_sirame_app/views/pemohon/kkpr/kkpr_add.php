							...
							<table class="table table-bordered" style="margin-bottom: 0">
								...
								<tr>
									<td width="50%">
										...
										<input type="text" name="namapelaku" class="form-control" minlength="8" required>
										<span id="span-noktp" class="text-red"></span>
									</td>
									<td width="50%">
										<label>NPWP</label>
										<input type="text" class="form-control" name="npwp" minlength="15" required>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<label>Alamat Kantor</label>
										<input type="text" class="form-control" name="alamatpelaku" minlength="10" required>
									</td>
								</tr>
								<tr>
									<td>
										<label>Telepon Kantor</label>
										<input type="text" class="form-control" name="tlppelaku" minlength="9" required>
									</td>
									<td>
										<label>Email Kantor</label>
										<input type="email" class="form-control" name="emailpelaku" minlength="15" required>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<label>Status Penanaman Modal</label>
										<input type="text" class="form-control" name="spm" minlength="3" required>
									</td>
								</tr>
								<tr>
									<td>
										<label>Skala Usaha</label>
										<input type="text" class="form-control" name="skalausaha" minlength="5" required>
									</td>
									<td>
								...
								<tr>
									<td colspan="2">
										...
										<input type="text" class="form-control" name="alamatusaha" minlength="10" required>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td colspan="2">
										...
										<input type="text" class="form-control" name="nomor" minlength="8" required>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										...
										<input type="text" class="form-control" name="pr" minlength="5" required>
									</td>
								</tr>
								<tr>
									<td>
										<label>Kode KBLI</label>
										<input type="text" class="form-control" name="kodekbli" minlength="3" required>
									</td>
									<td>
										<label>Judul KBLI</label>
										<input type="text" class="form-control" name="judulkbli" minlength="8" required>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										...
										<input type="text" class="form-control" name="ippr" minlength="8" required>
									</td>
									<td>
