        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
            <div class="box box-success">
				<div class="box-header with-border">
					...
					<a href="<?php echo base_url(); ?>pelaporan-adm/export_kkpr">
						<button type="button" class="btn bg-green-gradient btn-flat margin pull-right" style="margin-top: 0; margin-right: 0">
							<span class="fa  fa-cloud-download" style="margin-right: 5px"></span>
							Export Excel KKPR
						</button>
					</a>
					<a href="<?php echo base_url(); ?>pelaporan-adm/export">
						<button type="button" class="btn bg-green-gradient btn-flat margin pull-right" style="margin-top: 0; margin-right: 0">
							<span class="fa  fa-cloud-download" style="margin-right: 5px"></span>
							Export Excel Pelaporan
						</button>
					</a>
				</div>
                <!-- /.box-header -->
                        ...
                        <table id="example1" class="table table-bordered table-striped" style="width: 2000px">
                            ...
                            <?php $n=1; foreach ($kkpr as $field) { ?>
                                <tr>
                                    <td><?php echo $n++; ?></td>
									<td style="width: auto">
											<a href="<?php echo base_url(); ?>pelaporan-adm/detil/<?= $field->nomor; ?>">
									...
									<td><?php echo row($field->nomor,'pelaporan','nomor'); ?> Laporan</td>
