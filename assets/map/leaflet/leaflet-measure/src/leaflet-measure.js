!function (e) {
	...
	}(), i = {activeColor: "#a2290b", completedColor: "#d2350e"}, s = function () {
		function e(t) {
	...
	e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Pengukuran">Pengukuran</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3 style="font-size: 14px">Pengukuran</h3> <ul class=tasks> <a href=# class="js-start start">Buat pengukuran baru</a> </ul> </div> <div class=js-measuringprompt> <h3 style="font-size: 14px">Pengukuran</h3> <p class=js-starthelp>Mulailah membuat pengukuran dengan menambahkan titik ke peta</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Batal</a></li> <li><a href=# class="js-finish finish">Pengukuran Selesai</a></li> </ul> </div> </div> '
}, function (e, t, r) {
	e.exports = '<div class=group> <p class="lastpoint heading">Titik Koordinat Terakhir</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Jarak Jalur</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Luas Lahan</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function (e, t, r) {
	e.exports = '<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Titik tengah lahan</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Hapus</a></li> </ul> '
}, function (e, t, r) {
	e.exports = '<h3>Linear measurement</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Titik tengah lahan</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Hapus</a></li> </ul> '
}, function (e, t, r) {
	e.exports = '<h3 style="font-size: 14px">Hasil Pengukuran</h3> <p>Luas: {{ model.areaDisplay }}</p> <p>Panjang: {{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Titik tengah lahan</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Hapus</a></li> </ul> '
}]);
